...
#--------------------virus 클래스 정의 ----------------------------
class Virus:
    virus = pygame.image.load('./virus_imgs/virus.png')
    virus_L = pygame.image.load('./virus_imgs/virus_L.png')
    virus_M = pygame.image.load('./virus_imgs/virus_M.png')
    virus_S = pygame.image.load('./virus_imgs/virus_S.png')
...
class VirusFunc:
    ...
    sound = pygame.mixer.Sound("./virus_imgs/Rain.wav")
